                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" id="dob"
                                             placeholder="Enter Date of Birth" name="dob" value="{{ $staff->dob }}" >
                                            @if ($errors->has('dob'))
                                                <x-validation-errors>
                                                    {{ $errors->first('dob') }}
                                                </x-validation-errors>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="address"
                                                placeholder="Enter Address Here" name="address" value="{{ $staff->address }}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select id="position"  name="position" value="{{ $staff->position }}">

                ...
                <div class="col-sm-12">
                    <ol class="breadcrumb float-right">
                        <li class="breadcrumb-item">
                            <a href="{{ route('membersgym.index') }}">My Profile</a>
                        </li> 
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <form action="{{ route('memberprofile.edit', $member->id) }}" method="GET">
                                    <button type="submit" class="btn btn-secondary px-4" style="transition: background-color 0.3s;">Edit</button>
                                </form>
                            </div>
                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="name"
                                                placeholder="Enter Name Here" name="name" value="{{$member->name}}" readonly>
                                            @if ($errors->has('name'))
                                                <x-validation-errors>
                                                    {{ $errors->first('name') }}
                                                </x-validation-errors>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="address"
                                                placeholder="Enter Your Address" name="address" value="{{$member->address}}" disabled>
